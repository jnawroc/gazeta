...
\rfoot{\scriptsize Stron: \pageref{LastPage} Długość: \input{dlugosc.tex}kB\\Prowadzenie zajęć: \input{prowadzacy.tex}}
...
\end{center}
\begin{table}[b]
\centering{\LARGE Wersja \input{wersja.tex}}
\begin{tabular}{lc}
\begin{tabular}{l}
...
\ \ \ \bfseries{\large \input{prowadzacy.tex}}
\end{tabular}
&
\begin{tabular}{cc}
